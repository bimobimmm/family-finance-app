...
export default function SummaryPage() {
  ...
  async function init() {
    ...
    await loadReport(session.user.id, month)
    setLoading(false)
  }

  async function loadReport(uid: string, selectedMonth: string) {
      ...
      <div className="border-b bg-card">
        <div className="max-w-7xl mx-auto px-4 py-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p>Monthly personal financial report</p>
          </div>
        </div>
      </div>
